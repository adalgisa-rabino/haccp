...
public class UIRotateController : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    ...
    public void OnPointerDown(PointerEventData e) { rotateActions?.StartRotation(axisSign); }
    public void OnPointerUp(PointerEventData e) { rotateActions?.StopRotation(axisSign); }
    public void OnPointerExit(PointerEventData e) { rotateActions?.StopRotation(axisSign); }
}
